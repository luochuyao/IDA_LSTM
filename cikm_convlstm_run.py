...
parser.add_argument('--save_dir', type=str, default='checkpoints/cikm_convlstm')
parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_convlstm/')
